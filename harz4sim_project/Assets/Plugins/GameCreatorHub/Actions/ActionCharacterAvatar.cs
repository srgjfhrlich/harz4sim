namespace GameCreator.Characters
{
	...
	[AddComponentMenu("")]
	public class ActionCharacterAvatar : IAction
	{
        ...
        public override bool InstantExecute(GameObject target, IAction[] actions, int index)
        {
            ...
            if (charTarget != null && prefab != null)
            {
                ...
                {
                    Avatar prefabAvatar = prefab.GetComponent<Animator>().avatar;
                    if (prefabAvatar != null)
                    {
                        targetCharAnim.animator.avatar = prefabAvatar;
                    }
                }
            }
        ...
        public static new string NAME = "Character/Character Avatar";
        private const string NODE_TITLE = "Change character {0} avatar";
